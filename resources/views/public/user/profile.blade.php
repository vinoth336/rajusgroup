...
@endphp
<section id="page-title" class="page-title-pattern page-title-dark skrollable skrollable-between sticky" style="background-color: #e99c9b;padding:1rem 0;">
    ...
    <div class="container clearfix">
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="heading-block border-0" style="display:inline-block">
                                                ...
                                                <div class="col-sm-7">
                                                    <div
                                                        ...
                                                        <input
                                                            ...
                                                            data-required="false" aria-required="true" />
                                                        ...
                                                        <div class="col-sm-7">
                                                            <div
                                                                ...
                                                                <input
                                                                    ...
                                                                    value="{{ old('role', $memberOccupation->role) }}" data-required="false"
                                                                    aria-required="true" />
                                                                @if ($errors->has('role'))
                                                                    <span id="name-error" class="error text-danger"
                                                        ...
                                                        <div class="col-sm-7">
                                                            <div
                                                                ...
                                                                <input
                                                                    ...
                                                                    value="{{ old('organisation_details', $memberOccupation->organisation_details) }}" data-required="false"
                                                                    aria-required="true" />
                                                        ...
                                                        <div class="col-sm-7">
                                                            <div
                                                                ...
                                                                <input
                                                                    ...
                                                                    value="{{ old('job_location', $memberOccupation->job_location) }}" data-required="false"
                                                                    aria-required="true" />
                                                        ...
                                                        <div class="col-sm-7">
                                                            <div
                                                                ...
                                                                <input
                                                                    ...
                                                                    value="{{ old('parents', $memberFamily->parents) }}" data-required="false"
                                                                    aria-required="true" />
                                                        ...
                                                        <div class="col-sm-7">
                                                            <div
                                                                ...
                                                                <input
                                                                    ...
                                                                    value="{{ old('brothers', $memberFamily->brothers) }}" data-required="false"
                                                                    aria-required="true" />
                                                        ...
                                                        <div class="col-sm-7">
                                                            <div
                                                                ...
                                                                <input
                                                                    ...
                                                                    value="{{ old('sisters', $memberFamily->sisters) }}" data-required="false"
                                                                    aria-required="true" />
                                                        ...
                                                        <div class="col-sm-7">
                                                            <div
                                                                ...
                                                                <input
                                                                    ...
                                                                    value="{{ old('address', $memberLocation->address) }}" data-required="false"
                                                                    aria-required="true" />
                                                        ...
                                                        <div class="col-sm-7">
                                                            <div
                                                                ...
                                                                <input
                                                                    ...
                                                                    value="{{ old('pincode', $memberLocation->pincode) }}" data-required="false"
                                                                    aria-required="true" />
                                                        ...
                                                        <div class="col-sm-7">
                                                            <div
                                                                ...
                                                                <input
                                                                    ...
                                                                    value="{{ old('landmark', $memberLocation->landmark) }}" data-required="false"
                                                                    aria-required="true" />
